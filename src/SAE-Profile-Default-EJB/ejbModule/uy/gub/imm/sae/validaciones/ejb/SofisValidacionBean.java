...
@Stateless
public class SofisValidacionBean implements ValidadorReservaLocal, ValidadorReservaRemote {
    ...
    System.out.println("SofisValidacionBean.ejecutar -- ******************************");
    System.out.println("SofisValidacionBean.ejecutar -- nombreAccion="+nombreValidacion);
    for(String param : params.keySet()) {
      System.out.println("SofisValidacionBean.ejecutar -- ** "+param + " = "+params.get(param));
    }
    System.out.println("SofisValidacionBean.ejecutar -- ******************************");
