...
public class ValorConstanteValidacionRecurso implements Serializable{
	...
	public ValorConstanteValidacionRecurso() {
	}

	ValorConstanteValidacionRecurso(Integer id) {
		this.id = id;
	}
	...
	public boolean equals(Object o) {
		...
		ValorConstanteValidacionRecurso that = (ValorConstanteValidacionRecurso) o;
