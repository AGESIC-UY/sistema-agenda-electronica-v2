...
@Stateless
public class SofisAccionBean implements
    ...
    System.out.println("SofisAccionBean.ejecutar -- ******************************");
    System.out.println("SofisAccionBean.ejecutar -- nombreAccion="+nombreAccion);
    for(String param : params.keySet()) {
      System.out.println("SofisAccionBean.ejecutar -- ** "+param + " = "+params.get(param));
    }
    System.out.println("SofisAccionBean.ejecutar -- ******************************");
