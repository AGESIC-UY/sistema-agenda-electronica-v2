...
public class AtencionLLamadaReporteDT implements Serializable {
	...
	public AtencionLLamadaReporteDT(String nombFun, String nomAgenda,String nomRecurso,Integer nroPuesto,Date fechaHoraLlam,Date fechaHoraAten,String resolucionAtencion,Integer reservId,Date fechaHoraReserv)
	{
		nombFuncionario 	= nombFun;
		nombAgenda			= nomAgenda;
		nombRecurso			= nomRecurso;
		fechaHoraAtencion	= fechaHoraAten;
		fechaHoraLlamada	= fechaHoraLlam;
		puesto				= nroPuesto;
		atencion			= resolucionAtencion;
		reservaId			= reservId;
		fechaHoraReserva	= fechaHoraReserv;
	}
