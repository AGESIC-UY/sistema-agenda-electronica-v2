  ...
  private EntityManager globalEntityManager;
	...
	public void eliminarReservasPendientes(){
		...
		try {
		  ...
		  Query query =  globalEntityManager.createNativeQuery("SELECT clave, valor FROM global.ae_configuracion c WHERE c.clave IN ('RESERVA_PENDIENTE_TIEMPO_MAXIMO','RESERVA_MULTIPLE_PENDIENTE_TIEMPO_MAXIMO')");
